/* rules_rj_base.js - Pacote base (stub) RJ
...
export const PACK_INFO = { id:"RJ_BASE", nome:"RJ (Base)", versao:"0.1.0", atualizado:"2026-01-28", aviso:"⚠️ Pacote base RJ (stub). Não contém números oficiais." };
